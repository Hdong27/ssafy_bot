...
slack_token = "xoxb-507428687235-507365605316-3Z9a4Oo1ZdR5BE57sWkSkf69"  # 자신의 토큰 값을 입력해줍니다.
...
slack_verification = "7gxQltJgOcxOSPWbkKLAQhYQ"  # verification 값을 입력합니다.
...
def _11(search_url, item_name, sort):
    # 여기에 함수를 구현해봅시다.
    chrome_path = 'C:\\Users\\student\\Desktop\\chromedriver.exe'
